  ...
  return (
    <div className="flex flex-col md:flex-row md:justify-between justify-center md:items-center px-3 pt-3 md:pb-7 md:px-20 lg:px-32.5 md:pt-15 ">
      <div className="flex flex-col">
        ...
        <span className="font-bold text-lg   md:text-2xl text-nav-text">
      ...
      >
        <span className="ps-7 py-3 font-medium text-[14px]">View More</span>
        <img className="pe-7 py-3" src="src/assets/Vector.svg"></img>
      </button>
    </div>
  );
};
